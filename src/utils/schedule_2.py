...
def main():
    ...
    k = ["y00", "y01", "y02", "y03", "y10", "y11", "y12", "y13"]
    d = dict()
    for j in k:
        d[j] = []
    for j in k:
    ...
    selected_colours = ["#dc143c", "#f08080", "#ff6347", "#ff8c00"]#, "#ffa500"]
    ...
    ax[0].set_yticklabels(["OffLine", "ColdStart", "WarmStart", "Dispatch"], rotation=45)
    ax[0].grid(True)
    ax[0].invert_yaxis()
    ...
    ax[1].set_yticklabels(["OffLine", "ColdStart", "WarmStart", "Dispatch"], rotation=45)
    ax[1].grid(True)
    ax[1].invert_yaxis()
    ax[1].set_title("Unit b")

    plt.savefig("schedule_4.png")
